...
import com.paco.aad.PostgresqlDriver;
...
public class StudentJdbcRepository implements CrudRepository<Student> {
    ...
    public Student create(Student entity) {
        ...
        try (Connection conn = postgresqlDriver.getConnection();
            ...
            ps.setDate(3, entity.getBirthDate() != null ? Date.valueOf(entity.getBirthDate().toLocalDate()) : null);
    ...
    private Student mapRow(ResultSet rs) throws SQLException {
        ...
        // For example, rs.getBigDecimal("average_grade") != null ?
        s.setAverageGrade(rs.getBigDecimal("average_grade").doubleValue());
